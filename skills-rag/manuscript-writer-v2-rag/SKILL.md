...
**EMPHATIC: manuscript prose under edit must be read from the chapter files IN FULL — the RAG must never substitute for reading the text being worked on (including the self-diff voice gate, which audits real file text).**
