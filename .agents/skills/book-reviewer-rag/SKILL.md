...
1. Read [skills-rag/book-reviewer-rag/SKILL.md](../../../skills-rag/book-reviewer-rag/SKILL.md) completely, including any references it explicitly requires for the current task.
