...
1. Read [skills-rag/world-notes-seeder-rag/SKILL.md](../../../skills-rag/world-notes-seeder-rag/SKILL.md) completely, including any references it explicitly requires for the current task.
