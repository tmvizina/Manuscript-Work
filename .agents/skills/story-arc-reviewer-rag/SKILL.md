...
1. Read [skills-rag/story-arc-reviewer-rag/SKILL.md](../../../skills-rag/story-arc-reviewer-rag/SKILL.md) completely, including any references it explicitly requires for the current task.
