...
1. Read [skills-rag/book-reviewer-v2-rag/SKILL.md](../../../skills-rag/book-reviewer-v2-rag/SKILL.md) completely, including any references it explicitly requires for the current task.
