...
1. Read [skills-rag/chapter-title-cleanup-rag/SKILL.md](../../../skills-rag/chapter-title-cleanup-rag/SKILL.md) completely, including any references it explicitly requires for the current task.
